...
const RidesSection = () => {
  ...
  return (
    <div>
      ...
      <section
        className={`w-screen h-screen bg-[#22304a] flex flex-col overflow-hidden ${
          isOpen ? "opacity-50" : ""
        }`}
      >
        <Titlebar setIsOpen={setIsOpen} />
        <div className="flex flex-1 items-center justify-center">
          <div className="bg-[#22304a] z-30 flex flex-row items-center justify-center">
            ...
            />
            <div className="flex-1 w-auto min-w-[280px] max-w-[310px] h-[480px]"></div>
          </div>
